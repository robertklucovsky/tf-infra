...
- **Backend:** `backend "local"` v `tf/main.tf` (TEMPORARY pre teardown). Pôvodný `backend "pg"`
...
- **Otvorené otázky:** GitLab tenant (plánovaný, ešte nepridaný ako `.tf` v `tf/`).

Source pointery: `tf/main.tf`, git log @ 2026-06-28.
